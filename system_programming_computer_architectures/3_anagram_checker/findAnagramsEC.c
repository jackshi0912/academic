  ...
  while ( fgets( str, BUFSIZ, stdin ) != NULL ){ // Read a line into str
    ...
    */
    ...
    while ( result->hashKey == anagram->hashKey ) {
      ...
      (void) strncpy( str1, anagram->word, strlen( anagram->word) + 1 );
      (void) strncpy( str2, result->word, strlen( result->word) + 1 );
      ...
      if( strcmp( str1, str2 ) == 0 && ( sameVal != 0 ) ) {
