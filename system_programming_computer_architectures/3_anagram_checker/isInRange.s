...
isInRange:
	save	%sp, -96, %sp	! Save caller's window; if different than -96 
				! then comment on how the value was calculated
	...
	be 	greaterThanLower	! If inclusive, check if value is 
				! greater than or equal to lower 
	nop

	ba	greaterThanLowerEx	! if exclusive, check if value if 
...
greaterThanLower:
	...
	ble 	lessThanUpper	! Branch out if the min lower bound is less 
...
lessThanUpper:
	...
	bge 	valueIsValid	! Branch out if the max bound is greater or 
				! equal to the value
	nop
