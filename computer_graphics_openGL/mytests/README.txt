NOTE: This project consists of 3 smaller projects - mytest1, mytest2, and mytest3. You may click on the "mytest" solution or the "mytest1", "mytest2", or "mytest3" solutions inside the folders of the same name to run the project. This will load all 3 mytest projects up.
When running the projects, right click on either "mytest1", "mytest2", or "mytest3" under the solution explorer on the right side of your screen in Visual Studio, then select "Set as Startup Project". This will run the selected project when the green play button is pressed.
