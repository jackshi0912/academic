...
// ACTIVE_RADIUS is just how big we draw the red circle around the active points
...
public:
   ...
   // Should be GLuint, but there's no difference. This avoids the chaos of file inclusions.
