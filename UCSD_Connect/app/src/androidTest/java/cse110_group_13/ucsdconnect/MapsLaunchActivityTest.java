...
When: I hit the Action Bar pop up button
Then: The UI displays the action bar
When: I press the maps button
Then: The Google Maps Interface launches
 */
...
public class MapsLaunchActivityTest {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.newEmailField),
                        withParent(allOf(withId(R.id.activity_login),
                                withParent(withId(android.R.id.content)))),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("t@ucsd.edu"), closeSoftKeyboard());
