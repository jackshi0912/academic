/*      Given: The registered user is not logged in & airplane mode is enabled
        When: I enter my correct user name and password A& press login
        Then: Firebase Authorizes me and loads the homescreen
        When: I Launch the Map Application
        Then: The Map launches with best guess user location information
*/
...
public class MapsAirplaneMode {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void mapsAirplaneMode() {
