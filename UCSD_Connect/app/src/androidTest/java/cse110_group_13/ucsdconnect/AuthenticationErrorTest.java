/*      Given: The registered user is not logged in
        When: I enter my correct user name and password in airplane mode  & press login
        Then: Firebase Authorizes denies me access & gives an error
*/
...
public class AuthenticationErrorTest {
    ...
    @Test
    public void authenticationErrorTest() throws Exception {
